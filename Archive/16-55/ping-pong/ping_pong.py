...
class Player(GameSprite):
    ...
    def update_r(self):
        '''метод для управления спрайтом справа'''
        ...
        if keys[K_DOWN] and self.rect.y < win_height - 80:
            self.rect.y += self.speed
    def update_l(self):
        '''метод для управления спрайтом слева'''
        keys = key.get_pressed()
...
while game:
    ...
    if finish != True:
        ...
        '''если мяч достигает границ экрана по y, меняем направление его движения'''
        ...
        '''если мяч улетел вправо, выводим проигрыш второго игрока'''
